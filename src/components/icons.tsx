...
export function RedditSvg() {
  return (
    ...
    >
      ...
      <circle cx="64.483" cy="78.517" r="2.483" fill="#fff"></circle>
      <circle cx="16" cy="48" r="1" fill="#fff"></circle>
      <circle cx="86" cy="31" r="1" fill="#f1bc19"></circle>
      <circle cx="84" cy="45" r="2" fill="#fff"></circle>
      <circle cx="29" cy="47" r="5.3" fill="#fff"></circle>
      <path
        fill="#472b29"
      ...
      ></path>
      <g>
        <circle cx="72" cy="47" r="5.3" fill="#fff"></circle>
        <path
          fill="#472b29"
      ...
      <g>
        <ellipse cx="50.5" cy="54" fill="#fff" rx="24.8" ry="16.3"></ellipse>
        <path
          fill="#472b29"
      ...
      <g>
        <circle cx="69.5" cy="29.5" r="3.8" fill="#fff"></circle>
        <path
          fill="#472b29"
      ...
      <g>
        <circle cx="42" cy="51" r="3.5" fill="#ee3e54"></circle>
        <path
          fill="#472b29"
      ...
      <g>
        <circle cx="59" cy="51" r="3.5" fill="#ee3e54"></circle>
        <path
          fill="#472b29"
